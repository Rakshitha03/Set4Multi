<?php
	...
	{   
		...
		if($RoomId==$row['RoomId']) 
		{
			...
			if(substr_count($outprescards,$outprescards[0])==4||substr_count($outprescards,$outprescards[1])==4||substr_count($outprescards,$outprescards[2])==4||substr_count($outprescards,$outprescards[3])==4)
			{
